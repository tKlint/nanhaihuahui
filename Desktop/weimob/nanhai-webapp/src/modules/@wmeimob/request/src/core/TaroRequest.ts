 ...
 */
   ...
   * @param config
   */
  public put<T = any, U extends string | General.IAnyObject | ArrayBuffer = any | any>(url: string, data?: U, config?: Omit<ITaroRequestConfig, 'url' | 'data' | 'method'>) {
   ...
   * @param config
   */
  public post<T = any, U extends string | General.IAnyObject | ArrayBuffer = any | any>(url: string, data?: U, config?: Omit<ITaroRequestConfig, 'url' | 'data' | 'method'>) {
