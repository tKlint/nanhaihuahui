...
import { IAllRuleProps } from './const'
import MMNavigation from '~/modules/@wmeimob/taro-design/src/components/navigation'

const Component: FC<IAllRuleProps> = () => {
  return (
    <View className={styles.allRuleStyle}>
      {/* 各种规则说明 */}
      {/* 邀请规则 提现说明 */}
      <MMNavigation title="allRule" />
